                    ...
                    <ShareContent>
                        ...
                        <Editor>
                            ...
                            <UploadImage>
                                ...
                                assetArea ==='media' &&(
                                <>
                                    <input type="text" placeholder="Please input a video link" value={videoLink} onChange={e=>setVideoLink(e.target.value)} style={{padding:"10px 0"}}/>
...
const PostButton = styled.button`
  ...
  padding-right: 16px;
  background: ${
    props=> props.disabled ? 'rgba(0,0,0,0.8)': '#0a66c2'
  };
  border: none;
  color: ${
    props=> props . disabled ? 'rgba(1,1,1,0.2)': 'white'
  };
